...
if __name__ == "__main__":
    # Parameters for the PageRank-based scoring algorithm
    SIGMA = 1.0
    ALPHA = 0.15  # PageRank damping factor
    MAX_PR_ITERATIONS = 50 # Max iterations for PageRank convergence
    ...
    handle_user_edge_addition(G, updated_scores, sigma=SIGMA, alpha=ALPHA, max_pr_iterations=MAX_PR_ITERATIONS)
